            ...
            <div className="flex flex-col w-full">
                ...
                <div className="flex flex-wrap flex-col-reverse md:flex-row justify-between items-center">
                    ...
                    <div className="flex flex-col relative justify-start items-start w-full md:w-1/2 p-4 z-10">
                        ...
                        >
                            Knowledgeable, diligent and skilled software
                            development professional with over 5 years of
                            experience offering advanced abilities in a wide
                            range of programming languages, including
                            JavaScript, TypeScript, and Solidity. Quickly
                            understands requirements for new systems and creates
                            high-quality, clean, and robust code. Familiar with
                            testing, debugging, and correcting problems found in
